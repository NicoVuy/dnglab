...
pub enum ExifTag {
  ...
  // Sony makernote tags from https://exiv2.org/tags-sony.html and https://exiftool.org/TagNames/Sony.html
  SonyMoreInfo = 0x0020,
  ...
  SonyAFTracking = 0x2021, //detected values 00/01/02
  SonyMultiFrameNREffect = 0x2023,
  Sony2025 = 0x2025,
  SonyWBShiftABGMPrecise = 0x2026,
  SonyFocusLocation = 0x2027, // Sample 21C0 1680 196B 0DA4, first 2 words always the same
  ...
  SonyClarity = 0x2036,
  SonyFocusFrameSize = 0x2037, // various value slike BD 0 C0 0 1 1,
  Sony2038 = 0x2038,
